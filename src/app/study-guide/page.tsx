...
import {
  ...
  Lightbulb, Star, ListChecks, Info, CheckCircle2, FileText, ExternalLink
} from 'lucide-react';
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <a
              ...
              className="group bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md hover:border-emerald-200 transition-all"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-500 mb-2">
                    Comprehensive RVT study material
                  </p>
            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-500 mb-2">
                    Additional RVT review material
                  </p>
                  <div className="flex items-center gap-2 text-xs text-emerald-600">
                    <ExternalLink className="w-3 h-3" />
                    <span>Open PDF</span>
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group bg-white rounded-2xl shadow-sm border border-gray-100 p-6 hover:shadow-md hover:border-purple-200 transition-all sm:col-span-2"
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-500 mb-2">
                    Quick reference guide for key concepts and formulas
                  </p>
