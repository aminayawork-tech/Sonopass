                ...
                <div className="space-y-4">
                  <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded-r-lg">
                    <div className="flex items-start gap-2 mb-2">
                      ...
                      <h4 className="font-semibold text-blue-900 text-sm sm:text-base">Definition</h4>
                    </div>
                  ...
                  <div className="bg-emerald-50 border-l-4 border-emerald-500 p-4 rounded-r-lg">
                    <div className="flex items-start gap-2 mb-2">
                      ...
                      <h4 className="font-semibold text-emerald-900 text-sm sm:text-base">Remember This</h4>
                    </div>
                    <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                      Focus on the key concept: <strong className="text-emerald-900">{currentTerm.term}</strong> is essential for understanding {currentTerm.category} in sonography.
                    </p>
                  </div>
                  ...
                  <div className="bg-amber-50 border-l-4 border-amber-500 p-4 rounded-r-lg">
                    <div className="flex items-start gap-2 mb-2">
                      ...
                      <h4 className="font-semibold text-amber-900 text-sm sm:text-base">Study Tip</h4>
                    </div>
                    <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
                      Review this term in context with other <strong className="text-amber-900">{currentTerm.category}</strong> concepts for better retention.
                    </p>
                  </div>
                </div>
